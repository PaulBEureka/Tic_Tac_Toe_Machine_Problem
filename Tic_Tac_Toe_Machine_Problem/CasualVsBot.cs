...
{
    class CasualVsBot: CasualTwoPlayer // Inherit the class CasualTwoPlayer
    {
        ...
        public override string[] TileAndMarkCasual(string[] arr, string currentMark, string currentPlayer)
        {
        ...
        public override float GameResult(int status_Value, string player_Winner, string difficulty)
        {
            ...
            switch (status_Value)
            {
                ...
                case -1:
                    MessageBox.Show("All tiles are marked, It's a DRAW!!", "GameResult");
                    break;
            }
        ...
        public string[] ThreeByThreeCasualBot(string currentPlayer, string fplayer, string splayer)
        {
        ...
        public string[] SixBySixCasualBot(string currentPlayer, string fplayer, string splayer)
        {
            string currentMark = "X"; int status_Value; int tile_Num; string[] turnInfo_arr;
        ...
        public string[] TenByTenCasualBot(string currentPlayer, string fplayer, string splayer)
        {
            string currentMark = "X"; int status_Value; int tile_Num; string[] turnInfo_arr;
            bool timer_Status = false; string difficulty = "Average"; players[0] = fplayer; players[1] = splayer;
            Array_Initialize();
