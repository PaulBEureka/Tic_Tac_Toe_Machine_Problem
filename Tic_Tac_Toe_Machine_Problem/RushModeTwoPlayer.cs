...
{
    class RushModeTwoPlayer: CasualTwoPlayer // Polymorphism
    {
        ...
        public string[] TileAndMarkRush(string[] arr, string currentMark, string currentPlayer, float perTurnValue, float gameTimeValue)
        {
        ...
        public string[] ThreeByThreeRush(string currentPlayer, string fplayer, string splayer, float timePerTurn, float gameTime)
        {
            ...
            do
            {
                turnInfo_arr = TileAndMarkRush(easy_arr, currentMark, currentPlayer, timePerTurn, gameTime);
                if (!timer_Status)
                {
        ...
        public string[] SixBySixRush(string currentPlayer, string fplayer, string splayer, float timePerTurn, float gameTime)
        {
            string currentMark = "X"; int status_Value; int tile_Num; string[] turnInfo_arr;
            ...
            do
            {
                turnInfo_arr = TileAndMarkRush(average_arr, currentMark, currentPlayer, timePerTurn, gameTime);
                if (!timer_Status)
                {
                    GameTimer.CreateandRunTimer();
                    timer_Status = true;
        ...
        public string[] TenByTenRush(string currentPlayer, string fplayer, string splayer, float timePerTurn, float gameTime)
        {
            string currentMark = "X"; int status_Value; int tile_Num; string[] turnInfo_arr;
            ...
            do
            {
                turnInfo_arr = TileAndMarkRush(hard_arr, currentMark, currentPlayer, timePerTurn, gameTime);
                if (!timer_Status)
                {
                    GameTimer.CreateandRunTimer();
                    timer_Status = true;
